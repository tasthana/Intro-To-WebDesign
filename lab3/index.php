...
<html lang="en">
    ...
    <body>
        ...
        <!-- logo image would go here -->
            <h1>Origins of Tennis</h1>
            <h2>Rankings and Tournaments Explained</h2>
        </header>

        <nav>
            <a href="index.php">Home</a>
            <a href="detail.php">Wimbleden</a>
            <a href="form.php">Survey</a>
        </nav>

        <main>
            <h1 style="text-align: center;">Background Of Tennis</h1>
            ...
            <section>
                ...
                <p>There are different tiers of tournaments in tennis. There are the four Grand Slam tournaments, the French, Austrailian, US Open, and Wimbleden. 
            ...
            <section>
                ...
                By 25, he won Wimbleden, and became the first Swiss player to win that tournament. 
            ...
            <h2>Rankings</h2>
                <table>
                    ...
                    <tr>
                        <td>1</th>
                        <td>Carlos Alcaraz</th>
                        <td>At 19 years old, Alcaraz has 6,740 points.</th>
                    </tr>

                    <tr>
                        <td>2</th>
                        <td>Casper Rudd</th>
                        <td>At 23 years old, Rudd has 5,850 points. </th>
                    </tr>

                    <tr>
                        <td>3</th>
                        <td>Rafael Nadal</th>
                        <td>At 36 years old, Nadal has 5,810 points.</th>
                    </tr>

                    <tr>
                        <td colspan="3">Source : <cite><a href="https://www.britannica.com/sports/tennis/Professional-and-open-tennis"
                        target="_blank">https://www.britannica.com/sports/tennis/Professional-and-open-tennis</a></cite></td>
                    </tr>
            ...
            <section>
                ...
                <figure style="float: left; text-align: center; width:20%;">
                    <img alt ="Top 3" src="images/tennis.jpg" style="max-width: 100%;">
